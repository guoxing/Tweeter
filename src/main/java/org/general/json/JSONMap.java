...
public class JSONMap extends JSONObject {
    ...
    /**
     * @param key
     *            Key that is a string. Cannot be null. Can be empty.
     * @param value
     *            Value that is a string. Can be null or empty.
     ...
     *            Key that is a string. Cannot be null. Can be empty.
     * @param value
     *            Value that is a double. Can be null.
     * @throws NullPointerException
     *             Thrown if key is null
     */
     ...
     *            Key that is a string. Cannot be null. Can be empty.
     * @param value
     *            Value that is a long. Can be null.
     * @throws NullPointerException
     *             Thrown if key is null
     */
     ...
     *            Key that is a string. Cannot be null. Can be empty.
     * @param value
     *            Value that is an integer. Can be null.
     * @throws NullPointerException
     *             Thrown if key is null
     */
     ...
     *            Key that is a string. Cannot be null. Can be empty.
     * @param value
     *            Value that is a JSONObject. Can be null or empty.
     * @throws NullPointerException
     *             Thrown if key is null
     */
     ...
     *            Key that is a string. Cannot be null. Can be empty.
     * @param value
     *            Value that is an boolean. Can be null.
     * @throws NullPointerException
     *             Thrown if key is null
     */
     ...
     * @param value
     *            Value that is limited to valid JSON value types through the
     *            exposed public put methods.
     * @throws NullPointerException
     *             Thrown if key is null
     */
    private void genericPut(String key, Object value)
            throws NullPointerException {
        if (key == null) {
    ...
    /**
     * Returns a string formatted as a valid JSON associative array. See
     * http://json.org/ for more details on JSON formatting.
     */
    ...
    public boolean equals(Object other) {
        return (other instanceof JSONMap && ((JSONMap) other).map
                .equals(this.map));
    }
}
