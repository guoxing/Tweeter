...
public class FriendshipsController extends Controller {
     ...
     * 
     * Will return an empty JSON object on success, or a message with an error
     * (and a corresponding response status) otherwise.
     * 
     ...
     * @return Response that will have a body with an empty JSON object on
     *         success, or a message with an error.
     */
    ...
    public static AppResponse getFollowers(Map<String, String> params) {
        ...
        return generateSuccessResponse(generateJSONIdList(followerIds)
                .toString());
    }
