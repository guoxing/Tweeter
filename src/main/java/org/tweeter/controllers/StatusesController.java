...
public class StatusesController extends Controller {
     ...
     * @return App Response with a body with an empty JSON object on success, or
     *         a message indicating an error on failure.
     */
    ...
    /**
     * Returns the home timeline (in json) of a given user. The home timeline
     * includes statuses of all the user's friends and the user's own statuses.
     * 
     ...
     *            "count" and "max_id"
     * @return AppResponse with a body of a format as specified in
     *         generateJSONOfTweets on success, or an error message with an
     *         appropriate response status on failure.
     */
